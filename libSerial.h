...
const int CRC_Result[256] = { 0x0000, 0xc0c1, 0xc181, 0x0140, 0xc301, 0x03c0, 0x0280, 0xc241, 0xc601, 0x06c0, 0x0780,
...
HANDLE open_serial_port(const char* device, uint32_t baud_rate, uint32_t parity, uint32_t data_length, uint32_t stop_bit)
{
    ...
    state.ByteSize = data_length;
    state.Parity = parity;
    state.StopBits = stop_bit;
